    ...
    <div className="w-full">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://img.sanishtech.com/u/80ba7bf91e2c93bb9a400ce308759033.jpg"
      ...
      <section className="py-32 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Acoustic Resonance', img: 'https://img.sanishtech.com/u/1297fe39d4d78619c7901d0f700c901d.jpg', icon: <Music size={24} /> },
              { title: 'Earthy Flavors', img: 'https://img.sanishtech.com/u/78180a04eb3d0117a0aaeb09df0d846d.jpg', icon: <Utensils size={24} /> },
              { title: 'Liquid Spirits', img: 'https://img.sanishtech.com/u/ec29c594a71482d7970ac6322dee525b.jpg', icon: <GlassWater size={24} /> }
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="relative rounded-[1rem] overflow-hidden aspect-[16/9]">
                <img src="https://img.sanishtech.com/u/7143ee4f46a0788e7f2a8bfceaea1d66.jpg" alt="Ahmedabad Location" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90" referrerPolicy="no-referrer" />
            ...
            >
              <div className="relative rounded-[1rem] overflow-hidden aspect-[16/9]">
                <img src="https://img.sanishtech.com/u/2f7932f383a2a8d57538f94e7106feec.jpg" alt="Mehsana Location" className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 grayscale opacity-60" referrerPolicy="no-referrer" />
